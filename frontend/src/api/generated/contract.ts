...
export type ServiceMap = {
  ...
  "horibot/storage/srv/scan/list_sessions": { req: components["schemas"]["ListScanSessionsReq"]; res: components["schemas"]["ListScanSessionsRes"] };
  "horibot/storage/srv/scan/delete_session": { req: components["schemas"]["DeleteScanSessionReq"]; res: Record<string, never> };
  "horibot/storage/srv/scan/list": { req: components["schemas"]["ListScansReq"]; res: components["schemas"]["ListScansRes"] };
  "horibot/storage/srv/scan/delete": { req: components["schemas"]["DeleteScanReq"]; res: Record<string, never> };
  "horibot/storage/srv/reconstruction/list": { req: components["schemas"]["ListReconstructionsReq"]; res: components["schemas"]["ListReconstructionsRes"] };
  "horibot/storage/srv/reconstruction/delete": { req: components["schemas"]["DeleteReconstructionReq"]; res: Record<string, never> };
